...
-- en az 4 adet büyük ya da küçük harf farketmesizin 'T' karakteri içeren film 
-- isimlerini sıralayınız.
-- SELECT * FROM film WHERE title ILIKE '%t%t%t%t%';

-- SORU 4:
-- film tablosunda bulunan tüm sütunlardaki verilerden title 'C' karakteri 
-- ile başlayan ve uzunluğu (length) 90 dan büyük olan ve rental_rate 
-- 2.99 olan verileri sıralayınız.
